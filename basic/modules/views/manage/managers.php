            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th class="span3 sortable">
                            <span class="line"></span>id</th>
                        <th class="span2 sortable">
                            <span class="line"></span>邮件</th>
                        <th class="span3 sortable">
                            <span class="line"></span>登录时间</th>
                        <th class="span3 sortable">
                            <span class="line"></span>ip</th>
                        <th class="span3 sortable">
                            <span class="line"></span>登录时间</th>
                    ...
                    <tr class="first">
                        <td>
                            ...
                            <a href="#" class="name"><?php echo $manager->adminuser;?></a>
