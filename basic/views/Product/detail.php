            ...
            <div class="product-item-holder size-big single-product-gallery small-gallery">
                ...
                <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                        <a data-rel="prettyphoto" href="<?php echo 'http://'.$product['cover'] ?>">
                            <img class="img-responsive" alt="" src="<?php echo 'http://'.$product['cover'] ?>"  />
                        </a>
                    </div><!-- /.single-product-gallery-item -->
                    <?php $i = 2 ?>
                    <?php foreach((array)json_decode($product['pics'], true) as $k=>$pic): ?>
                        <div class="single-product-gallery-item" id="slide<?php echo $i ?>">
                            <a data-rel="prettyphoto" href="<?php echo 'http://'.$pic ?>">
                                <img class="img-responsive" alt="" src="<?php echo 'http://'.$pic ?>" />
                            </a>
                        </div><!-- /.single-product-gallery-item -->
                        <?php $i++ ?>
                    <?php endforeach; ?>
                ...
                <?php foreach($data['all'] as $pro): ?>
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="image">
                                <img alt="<?php echo $pro->title ?>" src="<?php echo 'http://'.$pro->cover ?>" data-echo="<?php echo 'http://'.$pro->cover ?>" />
                            </div>
                            <div class="body">
                                <div class="title">
